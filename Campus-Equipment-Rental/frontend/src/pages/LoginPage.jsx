...
export default function LoginPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (!res.ok) {
        setSubmitError(data?.detail || "Invalid credentials. Please try again.");
        return;
      }

      localStorage.setItem("student_id", data.id);
      localStorage.setItem("student_code", data.student_id);
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h2 className="text-4xl font-bold text-white leading-snug mb-4">
            Borrow smarter.<br />Return on time.
          </h2>
          <p className="text-white/70 text-[15px] leading-relaxed max-w-sm">
            The campus equipment rental system that keeps track of deposits, due dates, and late fees — automatically.
          </p>

          <div className="mt-10 flex flex-col gap-4">
            {[
              { icon: "🔒", text: "Secure deposit locking system" },
              { icon: "⏰", text: "Automated late fee calculations" },
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12 bg-[#fafafa]">
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8">
            ...
            <p className="text-stone-400 text-sm mt-1">Enter your credentials to access your account</p>
          </div>

          <form onSubmit={handleSubmit} className="flex flex-col gap-4">

            <div className="flex flex-col gap-1.5">
              <label className="text-[13px] font-semibold text-stone-600">
                Student ID
              </label>
              <input
                type="text"
                ...
                onChange={(e) => {
                  ...
                  if (errors.studentId) setErrors((p) => ({ ...p, studentId: undefined }));
                }}
            ...
            <div className="flex flex-col gap-1.5">
              <div className="flex justify-between items-center">
                ...
                <a href="/forgot-password" className="text-[12px] text-primary hover:underline font-medium">
                  Forgot password?
                </a>
              </div>
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-stone-400 hover:text-stone-600 min-h-0 min-w-0 p-1"
                >
