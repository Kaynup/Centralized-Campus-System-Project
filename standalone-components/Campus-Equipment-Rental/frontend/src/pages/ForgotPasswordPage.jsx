...
export default function ForgotPasswordPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (!res.ok) {
        setSubmitError(data?.detail || "Reset failed. Please try again.");
        return;
      }
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/70 text-[15px] leading-relaxed max-w-sm">
            No worries! Verify your student ID and registered email to reset your password securely.
          </p>
          <div className="mt-10 flex flex-col gap-4">
            {[
              { icon: "🔑", text: "Enter your student ID" },
              { icon: "📧", text: "Verify with your registered email" },
        ...
        <p className="relative z-10 text-white/40 text-xs">© 2026 EquipRent. All rights reserved.</p>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12 bg-[#fafafa]">
        <div className="w-full max-w-sm">
          ...
          {success ? (
            ...
            <>
              <div className="mb-8">
                <button onClick={() => navigate("/login")} className="flex items-center gap-1 text-sm text-stone-400 hover:text-stone-600 mb-6 min-h-0 min-w-0 p-0 bg-transparent">
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <p className="text-stone-400 text-sm mt-1">Verify your identity to set a new password</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-[13px] font-semibold text-stone-600">Registered Email</label>
                  <input
                    type="email"
                    value={email}
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-[13px] font-semibold text-stone-600">New Password</label>
