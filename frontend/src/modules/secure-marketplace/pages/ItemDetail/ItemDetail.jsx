    ...
    return (
      <div className="item-detail page">
        ...
        <div className="item-detail__error">
          ...
          <button className="btn btn-secondary btn-inline" onClick={() => navigate('/marketplace/browse')} type="button">
            Back to Marketplace
          </button>
        </div>
      </div>
      ...
      <div className={`item-detail__body ${canBuy && !isOwn ? 'item-detail__body--with-action' : ''}`}>
        ...
        <div className="item-detail__seller card">
          ...
          <button
            ...
            onClick={() => navigate(`/marketplace/messages/${item.id}`)}
            type="button"
          >
