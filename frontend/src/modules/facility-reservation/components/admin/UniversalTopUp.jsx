...
export default function UniversalTopUp({ onTopUpSuccess }) {
  ...
  const handleTopUp = async () => {
    ...
    try {
      ...
      notify.success(`Successfully topped up ${response.users_affected} users with ${parsedAmount} tokens.`);
      setAmount('');
      if (onTopUpSuccess) {
        onTopUpSuccess();
      }
      ...
      notify.error(err.response?.data?.message || 'Universal top-up failed');
    } finally {
